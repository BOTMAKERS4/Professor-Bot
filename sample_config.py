...
class Var(object):
   ...
   # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None)) 
    MAFIABOT_LOGGER = int(os.environ.get("PROFESSORBOT_LOGGER", None))
    ...
    if PRIVATE_GROUP_ID != None:
        try:
            ...
            raise ValueError("Invalid Private Group ID! Make sure your ID is starts with -100 and make sure that it's only numbers.")
