...
def button(page, modules):
    ...
    # Changing this line may give error in bot as i added some special cmds in ProfessorBot channel to get this module work...
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        if event.query.user_id == bot.uid and query == "@harshjais369":
            rev_text = query[::-1]
