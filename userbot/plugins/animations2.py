...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](harshjais369/ProfessorBot)**",
        ...
        "__INFO: ProfessorBot:Logged in as 557667062__",
        "__INFO: ProfessorBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
async def _(event):
    ...
    animation_chars = [
            ...
            "Hacking... 100%\n[████████████████████]\n`Scanning file...`\nETA: 0m, 00s",
            "Hacking complete!\nUploading file...",
            "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server.\Telegram Database:\n`./DOWNLOADS/msgstore.db.crypt12`",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
CmdHelp("animations2").add_command(
  ...
  "wahack", None, "Telegram Hack animation"
).add()
