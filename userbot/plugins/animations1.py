...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1212368262:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master!**\n\n__Your account is on hold! Pay 99$ to my master__ [Harsh Jaiswal](https://t.me/harshjais369) __to release your account__😏"
            )
        else:
            ...
            animation_chars = [
                ...
                "---------------->",
                "------>;(^。^)ノ",
                "(￣ー￣) Target kill successfully!\nLalalalalalala",
                "**Target killed successfully. Parmty!!! 🥳**",
            ]
