...
async def who(event):
    ...
    mafia = await edit_or_reply(
        event, "`Sit tight while I steal some data from this user...`"
    )
    ...
    try:
        ...
        await edit_or_reply(event, "`Couldn't fetch info of that user.`")
        return
...
async def fetch_info(replied_user, event):
    ...
    caption = "<b>𝖴𝖲𝖤𝖱 𝖨𝖭𝖥𝖮 𝖥𝖱𝖮𝖬 PROFESSOR-BOT'S 𝖣𝖠𝖳𝖠𝖡𝖠𝖲𝖤 :</b>\n\n"
